...
def plot_fk_domain(c, f,k,fst,fsx,vm=0, ax=None, 
    ...
    ----------
    c : numpy 2D array
        Any data generated by scipy.fftpack.fft2 with shape shape (len(k), len(f)).
    f : numpy 1D array
        Frequency axis generated by scipy.fftpack.fftfreq.
    k : numpy 1D array
        Wave number axis generated by scipy.fftpack.fftfreq.
    fst : float
